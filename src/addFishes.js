...
{
    //create a container to hold all fish sprites
    const fishContainer = new Container();

    //add the fish container ti the stage
    ...
    for (let i = 0; i < fishCount; i++)
    {
        ...
        //randomly scale the fish sprite to add some variety
...
export function animateFishes(app, fishes, time)
{
    ...
    //define the padding arround the stage where fishes are considered out of sight
